...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <style>
        ...
        .booking-form {
            ...
            padding: 40px;
            overflow: hidden;
            background-image: url('/Images/BookingsPage.jpg');
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span class="form-label">Check In</span> </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input class="form-control" type="date" required>
                                        <span class="form-label">Check out</span> </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span class="form-label">Email</span> </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input class="form-control" type="tel" placeholder="Enter your Phone">
                                        <span class="form-label">Phone</span> </div>
                                </div>
                            </div>
                            <div class="form-btn">
